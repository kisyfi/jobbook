<nav class="navbar navbar-expand-lg navbar-light">
  ...
  <div class="container">
        ...
        <div class="jumbotron-fluid" style="background-color: #ffffff; padding: 20px;">
          ...
          <div class="row">
            <div class="col-lg">
              <img src="asset/img/img-1.jpg" alt="img-1" class="img-col1">
            </div>
            <div class="col-lg">
              <img src="asset/img/img-2.jpg" alt="img-2" class="img-col1">
            </div>
            <div class="col-lg">
              <img src="asset/img/img-3.jpeg" alt="img-3" class="img-col1">
            </div>
          </div>
          <div class="row">
            <div class="col-lg">
              <img src="asset/img/img-4.jpg" alt="img-4" class="img-col1">
            </div>
            <div class="col-lg">
              <img src="asset/img/img-5.webp" alt="img-5" class="img-col1">
            </div>
            <div class="col-lg">
              <img src="asset/img/img-6.jpg" alt="img-5" class="img-col1">
            </div>
          </div>
        </div>
        <!-- last portofolio -->
